...
public class AntiPopLag extends Module {
    public AntiPopLag() {
        super("AntiPopLag", Category.CHAT, Keyboard.KEY_NONE);
    }
    @SubscribeEvent
    public void onChat(PacketReceiveEvent event) {
        ...
        if(event.getPacket() instanceof SPacketChat){
            ...
            if(msg.toLowerCase().contains(LAG_MESSAGE.toLowerCase())){
                event.setCanceled(true);
                sendMsg("Someone tried to pop lag you!");
            }
        }
    }
    private final String LAG_MESSAGE =
            "\u0101\u0201\u0301\u0401\u0601\u0701\u0801\u0901\u0A01" +
                    "\u0B01\u0E01\u0F01\u1001\u1101\u1201\u1301\u1401\u1501" +
                    "\u1601\u1701\u1801\u1901\u1A01\u1B01\u1C01\u1D01\u1E01" +
                    "\u1F01 \u2101\u2201\u2301\u2401\u2501\u2701\u2801\u2901" +
