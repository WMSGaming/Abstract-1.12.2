...
import com.wms.abstractclient.gui.modern.clickgui.settingButtons.*;
...
public class ModuleButton extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Gui.drawRect(frame.x, (int) (frame.y + offset), frame.x + (int) Sizing.WIDTH, (int) (frame.y + offset + Sizing.HEIGHT),new Color(0, 0, 0, 175).getRGB());

        if(module.isEnabled()) {
            Gui.drawRect(frame.x+1, (int) (frame.y + offset), frame.x + (int) Sizing.WIDTH - 1, (int) (frame.y + offset + Sizing.HEIGHT) - 1,new Color(uni.getRed(), uni.getGreen(), uni.getBlue(), 175).getRGB());
        }
